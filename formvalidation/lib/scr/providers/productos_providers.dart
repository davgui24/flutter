...
class ProductosProviders{
  ...
  final String _url = 'https://flutter-bdda5.firebaseio.com';
  ...
  Future<List<ProductoModel>> cargarProductos() async {
    ...
    decodeData.forEach((id, prod){
      ...
      prodTemp.id = id;productos.add(prodTemp);
  ...
  Future<String> subirImagen(File imagen) async{
    final url = Uri.parse('https://api.cloudinary.com/v1_1/dz2bv8w5b/image/upload?upload_preset=nolli8ks');
